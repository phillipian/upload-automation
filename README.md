...
- You can now run wp commands but you have to be in /Applications/MAMP/htdocs/wordpress/wp-includes (or you could just pass it into the command with --path=<path> or just cd into that directory inside the script which is what is there right now)
